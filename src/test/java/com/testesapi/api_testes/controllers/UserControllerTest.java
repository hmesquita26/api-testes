...
class UserControllerTest {
    ...
    void whenFindAllThenReturnAListOfUserDTO() {
        ...
        ResponseEntity<List<UserDTO>> response = controller.buscarTodos();
    ...
    void whenCreateThenReturnCreated() {
        ...
        ResponseEntity<UserDTO> response = controller.criar(userDTO);
    ...
    void whenUpdateThenReturnSuccess() {
        ...
        ResponseEntity<UserDTO> response = controller.atualizar(ID, userDTO);
    ...
    void whenDeleteThenReturnSuccess() {
        ...
        ResponseEntity<UserDTO> response = controller.excluir(ID);
